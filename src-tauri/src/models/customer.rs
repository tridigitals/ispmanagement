...
pub struct CustomerSubscriptionView {
    ...
    pub pppoe_address_pool: Option<String>,
    pub pppoe_isolation_pool: Option<String>,
    pub pppoe_disabled: Option<bool>,
...
pub struct InstallationWorkOrderView {
    ...
    pub subscription_grace_until: Option<DateTime<Utc>>,
    pub has_customer_package_invoice: bool,
