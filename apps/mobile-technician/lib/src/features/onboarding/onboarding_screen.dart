...
class _State extends ConsumerState<OnboardingScreen> {
  ...
  static final _pages = <_OnboardPage>[
    ...
    const _OnboardPage(
      ...
      title: 'Tiket & Tugas',
      body:
          'Lihat dan kelola tiket pelanggan serta work order lapangan dalam satu tempat.',
    ),
    const _OnboardPage(
      icon: Icons.headset_mic,
      title: 'Lapor Gangguan Cepat',
      body: 'Respon tiket pelanggan langsung dari HP. Update status real-time.',
    ),
    const _OnboardPage(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(icon, size: isPremium ? 64 : 48, color: isp.accentLight),
          ),
