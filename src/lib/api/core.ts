...
const commandMap: Record<string, { method: string; path: string }> = {
  ...
  enable_2fa_temp: { method: 'POST', path: '/auth/2fa/temp/enable' },
  verify_2fa_setup_temp: { method: 'POST', path: '/auth/2fa/temp/verify-setup' },
  request_email_2fa_setup_temp: { method: 'POST', path: '/auth/2fa/temp/email/enable-request' },
  verify_email_2fa_setup_temp: { method: 'POST', path: '/auth/2fa/temp/email/enable-verify' },
  ...
  update_tenant: { method: 'PUT', path: '/superadmin/tenants/:id' },
  ...
  list_pending_approvals: { method: 'GET', path: '/superadmin/registration-approvals' },
  approve_pending_user: { method: 'POST', path: '/superadmin/registration-approvals/:userId/approve' },
  reject_pending_user: { method: 'POST', path: '/superadmin/registration-approvals/:userId/reject' },
  ...
  list_message_templates: { method: 'GET', path: '/message-templates' },
  create_message_template: { method: 'POST', path: '/message-templates' },
  update_message_template: { method: 'PUT', path: '/message-templates/:id' },
  delete_message_template: { method: 'DELETE', path: '/message-templates/:id' },
  preview_message_template: { method: 'POST', path: '/message-templates/preview' },
  ...
  get_whatsapp_gateway_readiness: { method: 'GET', path: '/whatsapp/readiness' },
  send_customer_whatsapp: { method: 'POST', path: '/whatsapp/customer-send' },
  send_test_whatsapp: { method: 'POST', path: '/whatsapp/test-send' },
  list_whatsapp_events: { method: 'GET', path: '/whatsapp/events' },
  send_customer_email: { method: 'POST', path: '/customer-communication/email-send' },
