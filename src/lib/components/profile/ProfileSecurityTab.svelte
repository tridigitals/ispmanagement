        ...
        >
            <div class="setting-row">
                <div class="setting-info">
                    ...
                    <p class="setting-description">
                        Enter your existing password to make changes.
                    </p>
                </div>
            ...
            <div class="requirements-box">
                <span class="req-title"
                    >{$t("profile.security.requirements_title") ||
                        "Requirements"}</span
                >
                <ul class="req-list">
                    <li
                        class:valid={passwordData.new.length >=
        ...
        {#if twoFactorData.enabled}
            ...
            <div class="setting-row status-row success">
                ...
                <div class="setting-info">
                    <span class="setting-label"
                        >{$t("profile.security.twofa.enabled_title") ||
                            "2FA is Enabled"}</span
                    >
                    <p class="setting-description">
            ...
            {#if twoFactorData.showRecovery}
                ...
                <div class="recovery-box">
                    ...
                    <p>
                        These codes are the ONLY way to access your account if
                        you lose your phone.
                    </p>
                    <div class="code-grid">
                    ...
                    >
                        {$t("profile.security.twofa.recovery.saved_button") ||
            ...
            {:else}
                ...
                <div class="setting-row disable-row">
                    <div class="setting-info">
                        <span class="setting-label"
                            >{$t("profile.security.twofa.disable_title") ||
                                "Disable 2FA"}</span
                        >
                        <p class="setting-description">
                            Enter a code from your device to disable 2FA.
                        </p>
                    </div>
                    <div class="disable-actions">
                        ...
                        <button
                            ...
                            disabled={twoFactorData.disableCode.length < 6 ||
                                loading}
                        >
                            Disable
                        </button>
            ...
            {:else}
                <div class="setup-flow centered">
                    ...
                    <div class="setup-actions">
                        <button
                            class="btn btn-outline"
                            onclick={() => (twoFactorData.showSetup = false)}
                            >Cancel</button
                        >
                        <button
                            class="btn btn-primary"
    ...
    <div class="card-body">
        ...
        {:else}
            <p class="section-desc">
                Devices that have been authorized to skip 2FA for 30 days.
            </p>
                    ...
                    <div class="device-item">
                        ...
                        <div class="device-info">
                            <span class="device-name"
                                >{device.user_agent || "Unknown Device"}</span
                            >
                        ...
                        <button
                            class="btn btn-danger btn-sm"
                            onclick={() => confirmRevoke(device)}>Revoke</button
                        >
                    </div>
                {/each}
            </div>
