        ...
        {#if alertingEnabled}
            ...
            <div class="setting-row">
                <div class="setting-info">
                    <label class="setting-label" for="alerting-error-threshold">
                        {$t(
                            "superadmin.settings.alerting.error_threshold.label",
                        ) || "Error Rate Threshold (%)"}
                    </label>
                    <p class="setting-description">
                        {$t(
                            "superadmin.settings.alerting.error_threshold.desc",
            ...
            <div class="setting-row">
                <div class="setting-info">
                    <label
                        class="setting-label"
                        for="alerting-rate-limit-threshold"
                    >
                        {$t(
                            "superadmin.settings.alerting.rate_limit_threshold.label",
                        ) || "Rate Limit Threshold"}
                    </label>
                    <p class="setting-description">
                        {$t(
                            "superadmin.settings.alerting.rate_limit_threshold.desc",
                        ) ||
            ...
            <div class="setting-row">
                <div class="setting-info">
                    <label
                        class="setting-label"
                        for="alerting-response-time-threshold"
                    >
                        {$t(
                            "superadmin.settings.alerting.response_time_threshold.label",
                        ) || "P95 Response Time Threshold (ms)"}
                    </label>
                    <p class="setting-description">
                        {$t(
                            "superadmin.settings.alerting.response_time_threshold.desc",
