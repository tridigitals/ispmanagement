<script lang="ts">
  ...
  import { formatTime as formatTimeTz } from '$lib/utils/date';
  ...
  function formatTime(isoString: string): string {
    return formatTimeTz(isoString, { timeZone: $appSettings.app_timezone });
  }
</script>
      ...
      <div class="activity-list">
        {#each health.recent_activity as activity}
          <div class="activity-item" in:fade>
            <div class="activity-dot {getActionColor(activity.action)}"></div>
