/**
 * Ikon design system — path SVG inline, TIDAK async.
 *
 * Icon.svelte lama memakai dynamic import per ikon, sehingga ikon muncul
 * belakangan dan menggeser layout (layout shift) di setiap halaman. Di sini
 * path-nya jadi konstanta biasa: ikut masuk bundle, nol request, nol pop-in.
 *
 * Semua path digambar pada kanvas 24x24, stroke (bukan fill), supaya
 * ketebalannya konsisten di seluruh aplikasi.
 */
...
export const icons = {
  ...
  router:
    'M6.01 18H6M10.01 18H10M15 10v4M17.84 7.17a4 4 0 0 0-5.66 0M20.66 4.34a8 8 0 0 0-11.31 0M2 14h20v6H2z',
  ...
  /* Ikon tambahan untuk nav rail — memetakan nama lucide di Sidebar lama. */
  ...
  lifebuoy:
    'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4.93 4.93l4.24 4.24M14.83 14.83l4.24 4.24M14.83 9.17l4.24-4.24M14.83 9.17l3.53-3.53M4.93 19.07l4.24-4.24',
  ...
  radio:
    'M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4M16.24 7.76a6 6 0 0 1 0 8.49M7.76 16.24a6 6 0 0 1 0-8.49M19.07 4.93a10 10 0 0 1 0 14.14M4.93 19.07a10 10 0 0 1 0-14.14',
