  ...
  <section class="hero">
    ...
    <div class="hero-inner">
      <div class="hgroup">
        ...
        <h1 class="h1">{$t('admin.network.routers.ip_pools.title') || 'IP Pools'}</h1>
        <div class="sub">
          {$t('admin.network.routers.ip_pools.subtitle') ||
            'Per-router RouterOS IP pools (used for PPPoE remote-address mapping).'}
        </div>
      </div>
