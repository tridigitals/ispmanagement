        ...
        <header class="page-header">
            <div class="title-col">
                <div class="title-row">
                    ...
                    <span class="count-badge"
                        >{totalLoaded}/{totalAll}</span
                    >
                </div>
                <p class="muted">
                    {$t("notifications_page.subtitle") ||
                        "Updates, alerts, and system messages."}
                </p>
            </div>
            ...
            <div class="actions-col">
                ...
                >
                    ...
                    <span class="hide-xs"
                        >{$t("topbar.notifications_menu.settings") ||
                            "Settings"}</span
                    >
                </button>
            </div>
                ...
                {#each filteredNotifications as n (n.id)}
                    <article class="item" class:unread={!n.is_read}>
                        ...
                        >
                            <div class="left">
                                <div
                                    class="type-dot {n.notification_type}"
                                ></div>
                                <div class="text">
                                    <div class="row">
...
<ConfirmDialog
    ...
    title={$t("notifications_page.confirm_mark_all.title") ||
        "Mark all as read"}
    message={$t("notifications_page.confirm_mark_all.message") ||
