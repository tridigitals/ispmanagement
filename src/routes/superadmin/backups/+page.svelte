        ...
        <div class="flex gap-2">
            ...
            <button 
                ...
                onclick={() => {
                    // @ts-ignore
                    const isTauri = typeof window !== 'undefined' && !!(window as any).__TAURI_INTERNALS__;
                    if (isTauri) requestRestoreUpload(); else fileInput?.click();
                }}
            >
                {#if restoring}
                    ...
                    <tbody>
                        {#each backups as backup}
                            <tr>
                                ...
                                <td>
                                    <span class="badge" class:badge-blue={backup.backup_type === 'global'} class:badge-green={backup.backup_type === 'tenant'}>
                                        {backup.backup_type}
                                    </span>
                                </td>
