...
<div class="superadmin-content fade-in">
  ...
  {:else}
    ...
    >
      ...
      <button class="stat-card emerald" onclick={() => goto('/superadmin/tenants')}>
        <div class="stat-icon">
      ...
      <button class="stat-card indigo" onclick={() => goto('/superadmin/users')}>
        <div class="stat-icon">
      ...
      <button class="stat-card amber" onclick={() => goto('/superadmin/system')}>
        <div class="stat-icon">
